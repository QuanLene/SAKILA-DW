...
- Cơ sở dữ liệu **Sakila** là một phân hệ duy nhất, mô phỏng lại các hệ thống cửa hàng cho thuê DVD cùng một thương hiệu.
- Kho dữ liệu **Sakila** bao gồm các bảng **Dim** gồm dim_staff, dim_customer, dim_store, dim_date, dim_product; và một bảng **Fact** gồm fact_rental.
